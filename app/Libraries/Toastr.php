...
class Toastr
{
    ...
    public function __construct()
    {
        ...
        $session = $session->get();
        echo " --- instancia de session </br>";
    }

    public function sayHola($msg)
    {
        return ($msg);
    }
    /*
    ...
    public function success($msg)
    {
        ...
        session()->markAsTempdata('sucess', 1);
        //$session = \Config\Services::session();
        //$session = $session->get();
        //         
        //d(session()->cookie->getId());
        //$session->set('success', ['success' => $msg]);
        /*   session()->set([
            'success' => "bien de bien",
        ]);
        */

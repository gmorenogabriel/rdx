        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <small><?= lang('App.category.modify') ?></small>
                </h1>
            </section>
            <!-- Main content -->
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <?php endif;?>
                                <form action="<?php echo base_url();?>mant/categorias/update" method="POST">
                                    <input type="hidden" value="<?php echo $categoria->id;?>"
                                    name="idCategoria">
                                    <div class="form-group">
                                        <label  for="nombre"><?= lang('App.category.name') ?>:</label>
                                    ...
                                    <div class="form-group">
                                        <label  for="descripcion"><?= lang('App.category.description') ?>:</label>

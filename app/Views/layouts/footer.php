...
// <! -- Descmarca todos los checkbox luego que presiono agregarAlCarrito -->
document.addEventListener('DOMContentLoaded', function() {
        // Obtén el formulario de agregar al carrito
...
//     para el Carrito de Productos, manejo del Checkbox y Botones
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Función que verifica si se ha seleccionado al menos un producto y cantidad
        function verificarSeleccion() {
            ...
            checkboxs.forEach(function(checkbox) {
                ...
                // Si el checkbox está seleccionado y tiene una cantidad válida, habilitar el botón
                if (checkbox.checked && cantidadInput.value > 0 && stock > 0) {
                    habilitarBoton = true;
                }
            });
        ...
        checkboxs.forEach(function(checkbox) {
            checkbox.addEventListener('change', function() {
                ...
                // Habilitar o deshabilitar el campo de cantidad basado en si el checkbox está seleccionado y hay stock
                if (this.checked && stock > 0) {
                    cantidadInput.disabled = false;
                    cantidadInput.value = 1; // Establecer valor mínimo al habilitar
                } else {
                    cantidadInput.disabled = true;
                    cantidadInput.value = ''; // Limpiar valor cuando se deshabilita
                }

                // Verificar la selección para habilitar/deshabilitar el botón
                verificarSeleccion();
            });
        });
...
$('#liq2').DataTable({
 ...
 $(".btn-view-rep-cate").on("click", function(){
        // Capturamos el valor del botón
        console.log("btn-view-rep-cate");
        var  categoria = $(this).val();
		...
		let html="";
        html+="<p><strong>Id:</strong>"+infocategoria[0]+"</p>";
        html+="<p><strong>Nombre:</strong>"+infocategoria[1]+"</p>";
        html+="<p><strong>Descripcion:</strong>"+infocategoria[2]+"</p>";
        $("#modal-default .modal-body").html(html);
    });
	
  $(".btn-view-rep-prod").on("click", function(){
        // Capturamos el valor del botón
        console.log("btn-view-rep-prod");
        var  producto = $(this).val();
        ...
        html+="<p><strong>Nombre Producto:</strong>"+infoproducto[2]+"</p>";
        html+="<p><strong>Descripcion:</strong>"+infoproducto[3]+"</p>";
        html+="<p><strong>Precio:</strong>"+infoproducto[4]+"</p>";
        html+="<p><strong>Stock:</strong>"+infoproducto[5]+"</p>";
        $("#modal-default .modal-body").html(html);
    });
  $(".btn-view-rep-clie").on("click", function(){
        // Capturamos el valor del botón
        console.log("btn-view-rep-clie");
		var  cliente = $(this).val();
		console.log(cliente);
        // Quitamos los asteriscos del String recibido;
        var infocliente = cliente.split("*");
        console.log(infocliente);
		let html="";
		html+='<table id="rep-clie" class="table table-bordered btn-hover">';
		html+="<thead><tr>";
        ...
        html+="<th><strong>Ruc</strong></th>";
        html+="<th><strong>Empresa</strong></th>";
		html+="</thead></tr>";
	    
		html+="<tbody><tr>";
		html+="<td>"+infocliente[0]+"</td>";
        html+="<td>"+infocliente[1]+"</td>";
        html+="<td>"+infocliente[2]+"</td>";
        html+="<td>"+infocliente[3]+"</td>";
        html+="<td>"+infocliente[4]+"</td>";
        html+="<td>"+infocliente[5]+"</td>";
		html+="</body></tr>";
...
(function() {
        ...
        function logout() {
            ...
            window.location.href = "<?= base_url('auth/logout') ?>"; // Ruta para cerrar sesión
        }

...
<!--         <form action="#" method="get" class="sidebar-form">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li>
                <a href="<?php echo base_url();?>/">
                    <i class="fa fa-home"></i> <span>Inicio <?= session()->get('id_user'); ?></span>
                </a>
            </li>
            <li class="treeview">
                <a href="#">
        ...
        <?php if (session()->get('id_user')<3) : ?>
                <ul class="treeview-menu">
                    ...
                    <li><a href="<?php echo base_url(); ?>mant/productscart"><i class="fa fa-circle-o"></i> CartCcontroller</a></li>
                    <li><a href="<?php echo base_url(); ?>mant/carritoAgregar"><i class="fa fa-circle-o"></i> Carrito</a></li>
                </ul>
            </li>
            <li class="treeview">
                <a href="#">
        ...
        <?php else : ?>
            <ul class="treeview-menu">
                    <li><a href="<?php echo base_url(); ?>mant/carritoproductos"><i class="fa fa-circle-o"></i> Productos</a></li>
            </ul>
        <?php endif; ?>
        </ul>
    </section>
